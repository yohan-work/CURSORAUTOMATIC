document.addEventListener('DOMContentLoaded', async () => {
	...
	function displayMessages(channel) {
		...
		// Retrieve messages from sessionStorage instead of sessionStorage
		let messages = JSON.parse(sessionStorage.getItem(`messages-${channel}`)) || [];
	...
	function saveMessage(user, text, channel) {
		...
		sessionStorage.setItem(`messages-${channel}`, JSON.stringify(messages));
	}
